...
using ElmahCore.Mvc;
using ElmahCore;
using thirdcomponent.Api.Filters;
using thirdcomponent.Business.Installer;

namespace thirdcomponent.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "thirdcomponent API", Version = version + "-" + branch});
            });
